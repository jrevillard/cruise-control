...
public class AlertaSelfHealingNotifierTest {
    ...
    public void testSlackAlertWithEnvironment() throws ParseException {
        ...
        assertEquals(2, _notifier.getAlertaMessageList().size());
        assertTrue(_notifier.getAlertaMessageList().get(0).getEvent().startsWith("BROKER_FAILURE -"));
        assertTrue(_notifier.getAlertaMessageList().get(1).getEvent().startsWith("BROKER_FAILURE -"));
